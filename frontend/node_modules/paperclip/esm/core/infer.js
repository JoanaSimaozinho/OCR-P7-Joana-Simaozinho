import { NodeKind, AttributeKind, AttributeValueKind, ScriptExpressionKind, DynamicStringAttributeValuePartKind } from "paperclip-utils";
...
const addShapeInferenceProperty = (part, value, shape) => {
    ...
    return (Object.assign(Object.assign({}, shape), { properties: Object.assign(Object.assign({}, shape.properties), { [part.name]: {
                ...
                optional: ((_a = shape.properties[part.name]) === null || _a === void 0 ? void 0 : _a.optional) === false
                    ? (_b = shape.properties[part.name]) === null || _b === void 0 ? void 0 : _b.optional
                    : part.optional
            } }) }));
};
...
const inferScriptExpression = (expression, context, defaultInference = ANY_INFERENCE) => {
