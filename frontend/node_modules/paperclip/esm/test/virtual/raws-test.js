...
import { isNode, isRule, isMaybeStyleSheet, isStyleDeclaration, isStyleObject, isStyleSelector, NodeKind, RuleKind, SelectorKind, StyleDeclarationKind, AnnotationPropertyKind } from "paperclip-utils";
...
describe(__filename + "#", () => {
    ...
    `
        ...
        it(`Maintains the whitepsace for ${source.replace(/[\s\r\n\t]+/g, " ")}`, () => __awaiter(void 0, void 0, void 0, function* () {
            const graph = {
                "/entry.pc": source
            };
            const engine = yield createMockEngine(graph);
            yield engine.open("/entry.pc");
            const ast = (yield engine.getLoadedAst("/entry.pc"));
    ...
    if (isNode(ast)) {
        switch (ast.nodeKind) {
            ...
            case NodeKind.StyleElement: {
                const buffer = [(_a = ast.raws) === null || _a === void 0 ? void 0 : _a.before];
                buffer.push("<style>");
