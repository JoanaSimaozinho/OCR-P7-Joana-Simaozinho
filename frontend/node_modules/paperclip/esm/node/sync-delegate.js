...
// eslint-disable-next-line
export const createEngineDelegate = (options = {}, onCrash = () => { }) => {
    const io = getIOOptions(options || {});
    const { readFile, fileExists, resolveFile, getLintConfig, mode = EngineMode.SingleFrame } = io;
    return new EngineDelegate(NativeEngine.new(readFile, fileExists, resolveFile, getLintConfig, mode), io, onCrash ||
        function (e) {
            console.error(e);
        });
};
