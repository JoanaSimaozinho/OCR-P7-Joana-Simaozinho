...
*/
  static new(read_file: Function, file_exists: Function, resolve_file: Function, get_lint_config: Function, engine_mode: number): NativeEngine;
/**
* @returns {any}
*/
  generate_coverage_report(): any;
/**
* @param {string} uri
* @returns {any}
*/
...
* @returns {any}
*/
  inspect_node_styles(path: Uint32Array, uri: string, screen_width: number): any;
/**
* @param {string} uri
* @param {string} content
*/
